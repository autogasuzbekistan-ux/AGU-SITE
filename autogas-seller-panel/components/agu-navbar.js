// AGU Kontragent Navbar Component
// Barcha kontragent sahifalari uchun bir xil navbar
...
const AGU_NAVBAR = {
    ...
    render: () => {
        ...
        if (navbarContainer) {
            navbarContainer.innerHTML = AGU_NAVBAR.getNavbarHTML();
            AGU_NAVBAR.loadUserInfo();
        }
    }
};
